...
class App extends Phaser.Game {
    constructor(config: Phaser.IGameConfig) {
        ...
        this.state.add(Consts.SCENE_MAIN_MENU, MainMenu)
        this.state.add(Consts.SCENE_MAIN_GAME, MainGame)
...
window.onload = () => {
    ...
    let webFontsToLoad: string[] = ['Roboto','Holtwood One SC','Titan One','Luckiest Guy','Timmana']// GOOGLE_WEB_FONTS
